...
/**
 * simpleDateFormat 作为静态变量出现线程安全的问题,使用synchronized解决线程安全问题
 * 使用线程池
 ...
 * @Version 1.0
 **/
public class ThreadLocal004 implements Runnable{
    ...
    public static void main(String[] args) throws InterruptedException {
        ThreadLocal004 threadLocal001 = new ThreadLocal004();
